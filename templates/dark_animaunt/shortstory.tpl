            ...
            <div class="th-mask fx-col fx-center fx-middle">
                <div class="view_main_rod">
                    ...
                    <div class="main_com_post">
                        <div style="display: block;width: 50%;float: left;color: #fff;">{comments-num} <i
                                    class="fa fa-commenting" aria-hidden="true" style="
    color: #fff;
"></i></div>
                        <div style="display: block;width: 50%;float: left;color: #fff;">{rating} <i class="fa fa-heart"  aria-hidden="true"
                                                                                                    style="
    color: #fff;
"></i></div>
